...
from testsuites.test1 import DiscuzTest1
from testsuites.test2 import DiscuzTest2
from testsuites.test3 import DiscuzTest3
from testsuites.test4 import DiscuzTest4
# 设置报告文件的保存路径
